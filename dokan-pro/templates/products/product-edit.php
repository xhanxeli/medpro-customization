...
<div class="dokan-dashboard-wrap">
    ...
    <div class="dokan-dashboard-content dokan-product-edit">
     ...
     <div class="dokan-input-group">
          ...
          Expired Date <br><input class="dokan-form-control" name="_new_field" id="_new_field" type="date" placeholder="Expired date..." value="<?php echo dokan_posted_input( '_new_field' ); ?>">
     </div>
</div>
